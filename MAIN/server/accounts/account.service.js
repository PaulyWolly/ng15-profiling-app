...
async function uploadImage(id, imagePath) {
    ...
    account.profileImage = '/uploads/profiles/' + path.basename(imagePath);
    await account.save();
...
function basicDetails(account) {
    const { id, title, firstName, lastName, email, role, created, updated, profileImage } = account;
    return { id, title, firstName, lastName, email, role, created, updated, profileImage };
}
